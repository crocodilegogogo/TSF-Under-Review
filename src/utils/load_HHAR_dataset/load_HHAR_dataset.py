"""HHAR dataset can be Downloaded at http://archive.ics.uci.edu/dataset/341/smartphone+based+recognition+of+human+activities+and+postural+transitions"""

import os
from typing import Dict, Tuple
import numpy as np
import pandas as pd
from utils.load_HHAR_dataset.preprocess_raw_data import preprocess_raw_data

def load_HHAR_raw_data(DATA_DIR, SUBJECTS, TRAIN_SUBJECTS_ID, ACT_LABELS, window_size, overlap,
