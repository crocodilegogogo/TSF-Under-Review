"The implementation of article 'IF-ConvTransformer: A framework for human activity recognition using IMU fusion and ConvTransformer' (IF-ConvTransformer for wearable device-based datasets)"
...
class IF_ConvTransformer_WearableDevice(nn.Module):
    def __init__(self, input_2Dfeature_channel, input_channel, feature_channel,
        ...
        super(IF_ConvTransformer_WearableDevice, self).__init__()
